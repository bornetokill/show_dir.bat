...
Set /a counter=0
for /f "delims=" %%i in ('dir /b /a-h %1 2^>NUL') do set /a counter+=1
echo %counter%
goto :eof
:visible_files
echo::INCLUDES=VISIBLE FILES
Set /a counter=0
for /f "delims=" %%i in ('dir /b /a-d-h %1 2^>NUL') do set /a counter+=1
echo %counter%
goto :eof
:visible_directory
echo::INCLUDES=VISIBLE DIRECTORIES
Set /a counter=0
for /f "delims=" %%i in ('dir /b /ad-h %1 2^>NUL') do set /a counter+=1
echo %counter%
goto :eof
:hidden_all
echo::INCLUDES=HIDDEN FILES, HIDDEN DIRECTORIES
Set /a counter=0
for /f "delims=" %%i in ('dir /b /ah %1 2^>NUL') do set /a counter+=1
echo %counter%
goto :eof
:not_hidden_all
echo::INCLUDES=ALL FILES, ALL DIRECTORIES;
Set /a counter=0
for /f "delims=" %%i in ('dir /b /ad %1 2^>NUL') do set /a counter+=1
for /f "delims=" %%i in ('dir /b /a-d %1 2^>NUL') do set /a counter+=1
echo %counter%
goto :eof
:hidden_directory
echo::INCLUDES=HIDDEN DIRECTORIES ONLY
Set /a counter=0
for /f "delims=" %%i in ('dir /b /ahd %1 2^>NUL') do set /a counter+=1
echo %counter%
goto :eof
...
Set /a counter=0
for /f "delims=" %%i in ('dir /b /a-dh %1 2^>NUL') do set /a counter+=1
echo %counter%
goto :eof
:not_hidden_files
